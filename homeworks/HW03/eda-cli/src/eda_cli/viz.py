...
def plot_categorical_bar_chart(
    ...
    """
    Создаёт горизонтальный bar chart для категориальной колонки:
    - показывает количество объектов по категориям;
    - отображает top-N категорий.
    """
    if column not in df.columns:
        return  # колонки нет — ничего не рисуем
    ...
    plt.title(f"Top {top_n} категорий: {column}")
